            ...
            <div class="container">
                <div class="intro">
                    ...
                    <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                        ...
                        <p class="mb-3">Mỗi tách cà phê thủ công chất lượng của chúng tôi đều bắt đầu từ những nguyên liệu được hái thủ công có nguồn gốc địa phương. Sau khi bạn dùng thử, cà phê của chúng tôi sẽ là một sự bổ sung thú vị cho thói quen buổi sáng hàng ngày của bạn - chúng tôi đảm bảo điều đó!</p>
                        <div class="intro-button mx-auto"><a class="btn btn-primary btn-xl" href="Menu.php">Chọn đồ uống ngay!</a></div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            ...
                            <p class="mb-0">Khi bạn bước vào cửa hàng của chúng tôi để bắt đầu ngày mới, chúng tôi tận tâm cung cấp cho bạn dịch vụ thân thiện, bầu không khí thân thiện và trên hết là những sản phẩm tuyệt vời được làm bằng nguyên liệu chất lượng cao nhất. Nếu bạn không hài lòng, vui lòng cho chúng tôi biết và chúng tôi sẽ làm bất cứ điều gì có thể để khắc phục sự cố!</p>
                        </div>
                    </div>
                </div>
            </div>
...
<html>
    ...
    //     echo"
    //         <p>Chủ cửa hàng: </p>
    //         <p>Nguyễn Thị Tường Vy - B1809543</p>
            
    //     ";
    //     echo"
    //         <button type = 'button' ><a href='Menu.php'>Xem Menu </a></button><br><br>
    //         <button type = 'button' ><a href='FormDK.html'>Đăng Ký </a></button>
    //         <button type = 'button' ><a href='DangNhap.html'>Đăng Nhập </a></button>
    //         <button type = 'button' ><a href='DangXuat.php'>Đăng Xuất </a></button><br><br>
            
    //     ";
    //     echo "<button type = 'button'><a href='GioHang.php'>Xem Giỏ Hàng</a></button>";
    //     echo "<button type = 'button'><a href='DonHang.php'>Xem Đơn Hàng Đã Đặt</a></button>";
    //     echo "<table>";
