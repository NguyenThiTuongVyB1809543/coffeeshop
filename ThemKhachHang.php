                    ...
                    <div class='col-xl-9 mx-auto'>
                        <div class='cta-inner bg-faded text-center rounded'>
                            <h2 class='section-heading mb-5'>
                                ...
                                <span class='section-heading-lower'>Thêm khách hàng</span>
                            </h2>
                            <center>
            
                            <table>
                                <td>
                                    <form action='XuLiThemKhachHang.php' method='POST' enctype='multipart/form-data'>
                                        <table >
                                            <tr>
                                            ...
                                            <tr>
                                                <td rowspan='2'>
                                                    <center><input type='submit' value='Thêm khách hàng'></center>
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
