                    ...
                    <div class='col-xl-9 mx-auto'>
                        <div class='cta-inner bg-faded text-center rounded'>
                            <h2 class='section-heading mb-5'>
                                ...
                                <span class='section-heading-lower'>Sửa Chi Tiết Sản Phẩm</span>
                            </h2>
                            <center>
                            
                            <table>
                                <td>
                                    <form action='XuLiSua.php?masp=".$idsp." ' method='POST' enctype='multipart/form-data'>
                                        <table >
                                            <tr>
                                                <td>Tên sản phẩm</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td rowspan='2'>
                                                <div class='intro-button mx-auto'><input type='submit' class='btn btn-primary btn-xl' value = 'Cập nhật sản phẩm'></div>
                                                 </td>
                                            </tr>
                                        </table>
                                    </form>
